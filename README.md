# BSides Leeds 2026 Badge — Drumline Edition
...
adds a new rhythm game, unlocks all hidden LED animations from the start, and trades
...
- **New game: Drumline** — a rhythm game played on both eye-rings (details below).
...
- Drumline game and this build: community modification